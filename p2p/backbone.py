...
class BackboneBase_VGG(Backbone):
...
class Backbone_VGG(BackboneBase_VGG):
    ...
    def __init__(self, name: str, pretrained: bool, return_interm_layers: bool):
        if name == 'vgg16_bn':
...
def build_p2p_vgg_backbone(cfg, input_shape: ShapeSpec):
    return Backbone_VGG(
